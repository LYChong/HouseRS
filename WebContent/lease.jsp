    ...
    <div class="body4">
        <form action="Houseadd2Servlet" class="form-horizontal f1">
            <ul>
                ...
                <li><div class="form-group">
                    <label for="inputPassword8" class="col-sm-2 control-label">价格：</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPassword8" placeholder="输入出售金额" name="leasemoney">
                    </div>
                </div></li>
                

            </ul>
            <input type="hidden" name="csqk" value="false">
            <input type="hidden" name="username" value="<%=user%>">
            <button type="submit" class="btn btn-success btn-lg btn-block">上传出售</button>
        </form>
